...
Localhost (porta do host): http://127.0.0.1:5000

IP do container (interna): http://172.17.0.2:5000

⚠️ O Flask mostra ambos, mas você sempre deve acessar pelo localhost. O IP interno do container é apenas informativo.

⚠️ Observações

Tamanho da imagem: ~148MB

Número de camadas: ~23

Vulnerabilidades (Trivy scan): +100, incluindo 1 crítica

Limitações: a imagem contém pacotes do SO que podem ter vulnerabilidades e aumenta a superfície de ataque.
